...
int main(void){
  ...
  sprintf(nim,"VXDT5.dat");//la cadena nom='V.dat'
  tm2 = fopen(nim,"w"); //se crea el archivo V.dat
  sprintf(nim,"VYDT5.dat");//la cadena nom='V.dat'
  tm3 = fopen(nim,"w"); //se crea el archivo V.dat
  sprintf(nim,"DXDT5.dat");//la cadena nom='V.dat'
  tm4 = fopen(nim,"w"); //se crea el archivo V.dat
  sprintf(nim,"DYDT5.dat");//la cadena nom='V.dat'
  tm5 = fopen(nim,"w"); //se crea el archivo V.dat
  sprintf(nim,"THT5.dat");//la cadena nom='V.dat'
  tm6 = fopen(nim,"w"); //se crea el archivo V.dat
  for(id=ini;id<=Nexp;id++){//for over each different file
    sprintf(nam,"THR5T%d.dat",id);//la cadena nom='V.dat'
    ...
    //Nds Final time T
    for(i=0;i <= (Nds-12);i++){//loop getting theta  	
    ...
    for(i=0;i <= (Nds-12);i++){//loop for PTH and R
