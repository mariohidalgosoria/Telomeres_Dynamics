...
#include<math.h>
#include<stdlib.h>
#define Nds 11 //number of rows +1 in each file  MSDT50.dat
...
int main(void){
  ...
  for(id=ini;id<=Nexp;id++){          
    ...
    i=0;
    //Captura de datos:
    sprintf(nom,"CMSDT100_%d.dat",id);//coloca el id, xid.dat en una cadena 'nom'
  ...
  sprintf(nom,"CETAMSDT100.dat");//la cadena nom='x_mean.dat'
