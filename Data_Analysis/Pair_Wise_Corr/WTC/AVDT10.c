...
#include<math.h>
#include<stdlib.h>
#define Nds 21 //number of rows +1 in each file MTA2CDT1C%id.dat
...
int main(void){
  ...
  for(id=ini;id<=Nexp;id++){          
    i=0;
    //Captura de datos:
    sprintf(nom,"MTA2CDT10C%d.dat",id);//coloca el id, xid.dat en una cadena 'nom'
  ...
  sprintf(nom,"AVDT10.dat");//la cadena nom='x_mean.dat'
