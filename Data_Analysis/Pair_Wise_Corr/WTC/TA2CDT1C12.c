...
int main(void){
  ...
  sprintf(nam,"TA2CDT1C12.dat");//la cadena nom='V.dat'
...
//get data from file CCLATB.dat
  ...
  for(j=0;j <= Nds-3;j++){//X=[x0,x1,...,xNds-2] the loop has to go up to ((Nds-d)-2), to avoid evalution of Ser_X[Nds-1] and Ser_X[Nds]  
